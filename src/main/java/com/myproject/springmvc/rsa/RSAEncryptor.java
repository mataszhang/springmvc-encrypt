...
//            System.out.println("Decrypt result from ios client: \n" + decryptStringFromIOS);
    ...
    public String decryptWithBase64(String base64String) throws Exception {
        ...
        byte[] binaryData = decrypt(getPrivateKey(), Base64.decodeBase64(base64String.getBytes()) /*org.apache.commons.codec.binary.Base64.decodeBase64(base46String.getBytes())*/);
